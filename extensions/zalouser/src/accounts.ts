...
export function listZalouserAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ArenConfig): string {
...
function mergeZalouserAccountConfig(cfg: ArenConfig, accountId: string): ZalouserAccountConfig {
