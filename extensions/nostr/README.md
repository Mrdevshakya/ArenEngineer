...
Nostr DM channel plugin for Aren using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Aren. It enables your bot to:
...
# Configure aren to use local relay
