...
export function listGoogleChatAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ArenConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ArenConfig): ResolvedGoogleChatAccount[] {
