import type { ChannelOnboardingAdapter, ArenConfig, WizardPrompter } from "aren/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.aren.engineer/channels/mattermost",
    ].join("\n"),
