...
export function listMattermostAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ArenConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ArenConfig): ResolvedMattermostAccount[] {
