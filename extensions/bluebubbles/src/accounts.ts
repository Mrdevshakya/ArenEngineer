...
export function listBlueBubblesAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ArenConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ArenConfig): ResolvedBlueBubblesAccount[] {
