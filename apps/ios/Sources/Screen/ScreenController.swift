...
final class ScreenController {
    ...
    /// Callback invoked when an aren:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ArenKitResources.bundle
...
/// Handles navigation policy to intercept aren:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept aren:// deep links.
        if url.scheme?.lowercased() == "aren" {
