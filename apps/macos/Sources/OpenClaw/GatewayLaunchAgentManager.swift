...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.aren", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".aren/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.arenCommand(
            subcommand: "gateway",
