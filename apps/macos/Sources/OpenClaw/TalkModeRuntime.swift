...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.aren", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.aren", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ArenChatMessage] = messages.compactMap { item in
