...
enum UIStrings {
    static let welcomeTitle = "Welcome to Aren"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ArenOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ArenChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g aren@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ArenChatViewModel(
