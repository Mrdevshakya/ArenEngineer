...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .arenSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ArenPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ArenPaths.stateDirURL.path
...
extension Notification.Name {
    static let arenSelectSettingsTab = Notification.Name("arenSelectSettingsTab")
}
