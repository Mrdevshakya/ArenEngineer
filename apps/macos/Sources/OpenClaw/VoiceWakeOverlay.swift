...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.aren", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Aren windows, but below the system’s pop-up menus.
