...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ArenConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ArenConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ArenConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/aren"
        state.remoteCliPath = ""
        return state
    }
}
