...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.aren", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Aren/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__aren__/a2ui/").absoluteString + "?platform=macos"
    }
