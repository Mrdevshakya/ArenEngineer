...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/aren/aren") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/aren/aren")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://aren.engineer")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "ArenBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "ArenBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ArenGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ArenGitCommit") as? String) ??
            "unknown"
    }
