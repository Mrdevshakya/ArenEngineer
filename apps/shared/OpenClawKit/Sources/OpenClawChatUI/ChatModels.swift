...
public typealias ArenPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ArenPlatformImage = UIImage
#endif

public struct ArenChatUsageCost: Codable, Hashable, Sendable {
...
public struct ArenChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ArenChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ArenChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ArenChatMessageContent: Codable, Hashable, Sendable {
...
public struct ArenChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ArenChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ArenChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ArenChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ArenChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ArenChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ArenChatMessageContent].self, forKey: .content) {
...
public struct ArenChatHistoryPayload: Codable, Sendable {
...
public struct ArenSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ArenSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ArenSessionPreviewItem]
}

public struct ArenSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ArenSessionPreviewEntry]

    public init(ts: Int, previews: [ArenSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ArenChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ArenChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ArenAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ArenChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ArenGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ArenPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ArenPlatformImage?
...
public struct ArenChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
