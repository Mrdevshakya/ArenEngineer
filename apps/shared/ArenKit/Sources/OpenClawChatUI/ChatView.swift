...
@MainActor
public struct ArenChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ArenChatViewModel
    ...
    private var visibleMessages: [ArenChatMessage] {
        let base: [ArenChatMessage]
    ...
    private func mergeToolResults(in messages: [ArenChatMessage]) -> [ArenChatMessage] {
    ...
    private func isToolResultMessage(_ message: ArenChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ArenChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ArenChatMessage) -> String {
