...
enum ArenPlatformImageFactory {
    static func image(_ image: ArenPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
