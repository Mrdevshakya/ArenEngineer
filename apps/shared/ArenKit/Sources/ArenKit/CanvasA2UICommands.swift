...
public enum ArenCanvasA2UICommand: String, Codable, Sendable {
...
public struct ArenCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ArenCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
