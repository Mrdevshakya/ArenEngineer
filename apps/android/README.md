## Aren Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_aren-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm aren gateway --port 18789 --verbose
```
