---
summary: "Use Qwen OAuth (free tier) in Aren"
read_when:
  - You want to use Qwen with Aren
...
```bash
aren models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Aren will sync credentials
