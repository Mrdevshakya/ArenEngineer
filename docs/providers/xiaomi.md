---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Aren"
read_when:
  - You want Xiaomi MiMo models in Aren
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Aren uses
...
```bash
aren onboard --auth-choice xiaomi-api-key
# or non-interactive
aren onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
