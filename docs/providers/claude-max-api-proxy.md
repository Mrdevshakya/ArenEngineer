...
You can point Aren at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Aren
...
- [Anthropic provider](/providers/anthropic) - Native Aren integration with Claude setup-token or API keys
