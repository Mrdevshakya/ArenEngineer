---
summary: "Frequently asked questions about Aren setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Aren?](#whats-the-recommended-way-to-install-and-set-up-aren)
...
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [Windows install says git not found or aren not recognized](#windows-install-says-git-not-found-or-aren-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Aren on Linux?](#how-do-i-install-aren-on-linux)
  - [How do I install Aren on a VPS?](#how-do-i-install-aren-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Aren to update itself?](#can-i-ask-aren-to-update-itself)
  ...
  - [If I buy a Mac mini to run Aren, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-aren-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Aren instances?](#can-multiple-people-use-one-whatsapp-number-with-different-aren-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Aren on a dedicated machine?](#how-important-is-it-to-run-aren-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Aren in a VM and what are the requirements](#can-i-run-aren-in-a-vm-and-what-are-the-requirements)
- [What is Aren?](#what-is-aren)
  - [What is Aren, in one paragraph?](#what-is-aren-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Aren](#what-are-the-top-five-everyday-use-cases-for-aren)
  - [Can Aren help with lead gen outreach ads and blogs for a SaaS](#can-aren-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Aren run tasks on a schedule or continuously in the background?](#can-aren-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Aren saved locally?](#is-all-data-used-with-aren-saved-locally)
  - [Where does Aren store its data?](#where-does-aren-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Aren?](#how-do-i-completely-uninstall-aren)
...
- [Config basics](#config-basics)
  ...
  - [Can the Aren browser run headless?](#can-the-aren-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Aren instances talk to each other (local + VPS)?](#can-two-aren-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Aren load environment variables?](#how-does-aren-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Aren instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-aren-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Aren but keep it installed?](#how-do-i-completely-reset-aren-but-keep-it-installed)
  ...
  - [Why doesn’t Aren reply in a group?](#why-doesnt-aren-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Aren, Flawd, and Krill use for models?](#what-do-aren-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `aren gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-aren-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `aren gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-aren-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Aren in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-aren-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Aren?](#i-closed-my-terminal-on-windows-how-do-i-restart-aren)
  ...
  - [ELI5: `aren gateway restart` vs `aren gateway`](#eli5-aren-gateway-restart-vs-aren-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Aren to inbound DMs?](#is-it-safe-to-expose-aren-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/aren/aren-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ```bash
   aren health --json
   aren health --verbose   # shows the target URL + config path on errors
   ```
...
https://github.com/aren/aren/issues
https://github.com/aren/aren/pulls
...
- `aren status`: quick snapshot of gateway/agent health + basic config.
- `aren models status`: checks provider auth + model availability.
- `aren doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `aren status --all`, `aren logs --follow`,
`aren gateway status`, `aren health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Aren
...
```bash
git clone https://github.com/aren/aren.git
cd aren
pnpm install
pnpm build
...
If you don’t have a global install yet, run it via `pnpm aren onboard`.
...
- If it asks for auth, run `aren dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `AREN_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `aren gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `aren gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `aren dashboard`.
...
1. Install Aren on the new machine.
2. Copy `$AREN_STATE_DIR` (default: `~/.aren`) from the old machine.
3. Copy your workspace (default: `~/.aren/workspace`).
4. Run `aren doctor` and restart the Gateway service.
...
under `~/.aren/` (for example `~/.aren/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-aren-store-its-data),
...
https://github.com/aren/aren/blob/main/CHANGELOG.md
...
https://github.com/aren/aren/tree/main/docs
...
### Windows install says git not found or aren not recognized
...
**2) aren is not recognized after install**
...
### How do I install Aren on Linux
...
### How do I install Aren on a VPS
...
### Can I ask Aren to update itself
...
aren update
aren update status
aren update --channel stable|beta|dev
aren update --tag <dist-tag|version>
aren update --no-restart
```

If you must automate from an agent:

```bash
aren update --yes --no-restart
aren gateway restart
```
...
`aren onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Aren with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `aren models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `aren models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `aren models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. Aren no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Aren can keep replying while a provider is rate‑limited.
...
Aren supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Aren fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `aren.json`.

Steps:

1. Enable the plugin: `aren plugins enable google-gemini-cli-auth`
2. Login: `aren models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Aren needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Aren runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Aren’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Aren can I connect it to my MacBook Pro
...
- Use `aren nodes status` / `aren nodes list` to see it.
...
- DM your bot, then run `aren logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Aren instances
...
If you run Aren via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the Aren code install. Your state
(`~/.aren`) and workspace (`~/.aren/workspace`) stay untouched.
...
**Aren-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Aren on a dedicated machine
...
Aren is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Aren in a VM and what are the requirements
...
### What is Aren in one paragraph

Aren is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Aren is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Aren
...
### Can Aren help with lead gen outreach ads and blogs for a SaaS
...
Aren draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Aren is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Aren when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.aren/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.aren/aren.json`). Precedence is `<workspace>/skills` > `~/.aren/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.aren/aren.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.aren/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Aren treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `AREN_SKIP_CRON` is not set.
...
```bash
aren cron run <jobId> --force
aren cron runs --id <jobId> --limit 50
```
...
### Can Aren run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.aren.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-aren-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Aren can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.aren/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: { "aren": { "os": ["darwin", "linux"], "requires": { "bins": ["imsg"] } } }
   ---
   ```
4. Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Aren only needs stdio). See [iMessage](/channels/imessage).
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Aren workspace); Aren treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.aren/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
aren browser extension install
aren browser extension path
```
...
Aren memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Aren also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Aren auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Aren
prefers `local`.
...
### Is all data used with Aren saved locally

No - **Aren’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.aren` + your workspace directory).
...
### Where does Aren store its data

Everything lives under `$AREN_STATE_DIR` (default: `~/.aren`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$AREN_STATE_DIR/aren.json`                             | Main config (JSON5)                                          |
| `$AREN_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$AREN_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$AREN_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$AREN_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$AREN_STATE_DIR/agents/`                                   | Per‑agent state (agentDir + sessions)                        |
| `$AREN_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$AREN_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single‑agent path: `~/.aren/agent/*` (migrated by `aren doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.aren/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.aren`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.aren`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.aren/skills`).

Default workspace is `~/.aren/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.aren/workspace" } },
}
```
...
Do **not** commit anything under `~/.aren` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Aren
...
`workspace` to the repo root. The Aren repo is just source code; keep the
...
Aren reads an optional **JSON5** config from `$AREN_CONFIG_PATH` (default: `~/.aren/aren.json`):

```
$AREN_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/.aren/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `AREN_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `aren doctor --generate-gateway-token`.
...
key. **Recommended:** run `aren configure --section web` to store it in
...
- Daemons read env vars from `~/.aren/.env` (or the service environment).
...
### Can the Aren browser run headless
...
- Gateway is running: `aren gateway status`
- Gateway health: `aren status`
- Channel health: `aren channels status`
...
### Can two Aren instances talk to each other local VPS
...
`aren agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
aren agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.aren/aren.json`).
- If you have no backup, re-run `aren doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `aren config set` for small changes.
- Use `aren configure` for interactive edits.
...
### How does Aren load environment variables

Aren reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.aren/.env` (aka `$AREN_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.aren/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`AREN_LOAD_SHELL_ENV=1`, `AREN_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`aren models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Aren won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.aren/.env`:
   ```
...
### Is there a way to make a team of Aren instances one CEO and many agents
...
### How do I completely reset Aren but keep it installed
...
```bash
aren reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `AREN_PROFILE`), reset each state dir (defaults are `~/.aren-<profile>`).
- Dev reset: `aren gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Aren skips the heartbeat run to save API calls.
...
No. Aren runs on **your own account**, so if you’re in the group, Aren can see it.
...
```bash
aren directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Aren reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.aren/agents/<agentId>/sessions/`.
...
- Use `aren doctor` to spot stray workspaces and profile mismatches.
...
Aren’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Aren currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `aren models set ...` (updates just model config)
- `aren configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.aren/aren.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `aren doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Aren, Flawd, and Krill use for models

- **Aren + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. Aren ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.aren/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `aren agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Aren can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.aren/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.aren/agent/*` (migrated by `aren doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.aren/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `aren models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `aren models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `aren models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.aren/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    aren models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Aren will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Aren now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Aren uses provider‑prefixed IDs like:
...
Aren may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `aren models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
aren models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
aren models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
aren models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
aren models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > AREN_GATEWAY_PORT > gateway.port > default 18789
```

### Why does aren gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `aren gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does aren gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `AREN_STATE_DIR` mismatch).

Fix:

```bash
aren gateway install --force
```
...
Aren enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `aren gateway --port <port>`.

### How do I run Aren in remote mode client connects to a Gateway elsewhere
...
- `aren gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `aren.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `aren dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `aren doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `AREN_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `aren status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `AREN_CONFIG_PATH` (per‑instance config)
- `AREN_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `aren --profile <name> …` per instance (auto-creates `~/.aren-<name>`).
...
```
aren tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$AREN_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.aren/logs/...`; profiles use `~/.aren-<profile>/logs/...`)
- Linux: `journalctl --user -u aren-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Aren Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `aren gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Aren
...
1. Is the Gateway running? `aren gateway status`
2. Is the Gateway healthy? `aren status`
3. Does the UI have the right token? `aren dashboard`
...
```bash
aren channels status
aren channels logs --channel telegram
```
...
### ELI5 aren gateway restart vs aren gateway

- `aren gateway restart`: restarts the **background service** (launchd/systemd).
- `aren gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `aren gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Aren assistant setup](/start/aren) and [Agent send](/tools/agent-send).

CLI sending:

```bash
aren message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Aren to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `aren pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `aren pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `aren doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Aren only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
aren pairing approve whatsapp <code>
```

List pending requests:

```bash
aren pairing list whatsapp
```
...
Aren blocks **cross‑provider** messaging by default. If a tool call is bound
