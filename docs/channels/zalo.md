...
- Install via CLI: `aren plugins install @aren/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `aren plugins install ./extensions/zalo`
   - From npm (if published): `aren plugins install @aren/zalo`
...
- Approve via:
  - `aren pairing list zalo`
  - `aren pairing approve zalo <CODE>`
...
- Example: `aren message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `aren channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `aren logs --follow`
