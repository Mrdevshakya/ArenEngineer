...
Aren treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.aren/settings/voicewake.json`

Shape:

```json
{ "triggers": ["aren", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
