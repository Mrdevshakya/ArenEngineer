...
Aren has two separate “streaming” layers:
...
When block streaming is enabled, Aren can **merge consecutive block chunks**
...
When draft streaming is active, Aren disables block streaming for that reply to avoid double-streaming.
