...
This page ties together how Aren handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Aren keeps a
...
Aren separates the **prompt body** from the **command body**:
...
Aren can expose or hide model reasoning:
