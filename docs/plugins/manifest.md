...
read_when:
  - You are building a Aren plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (aren.plugin.json)

Every plugin **must** ship a `aren.plugin.json` file in the **plugin root**.
Aren uses this manifest to validate configuration **without executing plugin
