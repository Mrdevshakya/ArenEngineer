...
[Website](https://aren.ai) · [Docs](https://docs.aren.ai) · [DeepWiki](https://deepwiki.com/aren/aren) · [Getting Started](https://docs.aren.ai/start/getting-started) · [Updating](https://docs.aren.ai/install/updating) · [Showcase](https://docs.aren.ai/start/showcase) · [FAQ](https://docs.aren.ai/start/faq) · [Wizard](https://docs.aren.ai/start/wizard) · [Nix](https://github.com/aren/nix-aren) · [Docker](https://docs.aren.ai/install/docker) · [Discord](https://discord.gg/aren)
...
New install? Start here: [Getting started](https://docs.aren.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.aren.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.aren.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.aren.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.aren.ai/start/getting-started)
...
Upgrading? [Updating guide](https://docs.aren.ai/install/updating) (and run `aren doctor`).
...
Details: [Development channels](https://docs.aren.ai/install/development-channels).
...
Full security guide: [Security](https://docs.aren.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.aren.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.aren.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.aren.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.aren.ai/nodes/voicewake) + [Talk Mode](https://docs.aren.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.aren.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.aren.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.aren.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.aren.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.aren.ai/nodes).
- **[Onboarding](https://docs.aren.ai/start/wizard) + [skills](https://docs.aren.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.
...
- [Gateway WS control plane](https://docs.aren.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.aren.ai/web), and [Canvas host](https://docs.aren.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.aren.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.aren.ai/start/wizard), and [doctor](https://docs.aren.ai/gateway/doctor).
- [Pi agent runtime](https://docs.aren.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.aren.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.aren.ai/concepts/groups).
- [Media pipeline](https://docs.aren.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.aren.ai/nodes/audio).

### Channels

- [Channels](https://docs.aren.ai/channels): [WhatsApp](https://docs.aren.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.aren.ai/channels/telegram) (grammY), [Slack](https://docs.aren.ai/channels/slack) (Bolt), [Discord](https://docs.aren.ai/channels/discord) (discord.js), [Google Chat](https://docs.aren.ai/channels/googlechat) (Chat API), [Signal](https://docs.aren.ai/channels/signal) (signal-cli), [iMessage](https://docs.aren.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.aren.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.aren.ai/channels/msteams) (extension), [Matrix](https://docs.aren.ai/channels/matrix) (extension), [Zalo](https://docs.aren.ai/channels/zalo) (extension), [Zalo Personal](https://docs.aren.ai/channels/zalouser) (extension), [WebChat](https://docs.aren.ai/web/webchat).
- [Group routing](https://docs.aren.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.aren.ai/channels).

### Apps + nodes

- [macOS app](https://docs.aren.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.aren.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.aren.ai/nodes/talk) overlay, [WebChat](https://docs.aren.ai/web/webchat), debug tools, [remote gateway](https://docs.aren.ai/gateway/remote) control.
- [iOS node](https://docs.aren.ai/platforms/ios): [Canvas](https://docs.aren.ai/platforms/mac/canvas), [Voice Wake](https://docs.aren.ai/nodes/voicewake), [Talk Mode](https://docs.aren.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.aren.ai/platforms/android): [Canvas](https://docs.aren.ai/platforms/mac/canvas), [Talk Mode](https://docs.aren.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.aren.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.aren.ai/tools/browser): dedicated aren Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.aren.ai/platforms/mac/canvas): [A2UI](https://docs.aren.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.aren.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.aren.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.aren.ai/automation/cron-jobs); [webhooks](https://docs.aren.ai/automation/webhook); [Gmail Pub/Sub](https://docs.aren.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.aren.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.aren.ai/concepts/channel-routing), [retry policy](https://docs.aren.ai/concepts/retry), and [streaming/chunking](https://docs.aren.ai/concepts/streaming).
- [Presence](https://docs.aren.ai/concepts/presence), [typing indicators](https://docs.aren.ai/concepts/typing-indicators), and [usage tracking](https://docs.aren.ai/concepts/usage-tracking).
- [Models](https://docs.aren.ai/concepts/models), [model failover](https://docs.aren.ai/concepts/model-failover), and [session pruning](https://docs.aren.ai/concepts/session-pruning).
- [Security](https://docs.aren.ai/gateway/security) and [troubleshooting](https://docs.aren.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.aren.ai/web) + [WebChat](https://docs.aren.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.aren.ai/gateway/tailscale) or [SSH tunnels](https://docs.aren.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.aren.ai/install/nix) for declarative config; [Docker](https://docs.aren.ai/install/docker)-based installs.
- [Doctor](https://docs.aren.ai/gateway/doctor) migrations, [logging](https://docs.aren.ai/logging).
...
- **[Gateway WebSocket network](https://docs.aren.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.aren.ai/gateway)).
- **[Tailscale exposure](https://docs.aren.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.aren.ai/gateway/remote)).
- **[Browser control](https://docs.aren.ai/tools/browser)** — Aren-managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.aren.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.aren.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.aren.ai/nodes/voicewake) + [Talk Mode](https://docs.aren.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.aren.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.
...
Details: [Tailscale guide](https://docs.aren.ai/gateway/tailscale) · [Web surfaces](https://docs.aren.ai/web)
...
Details: [Remote access](https://docs.aren.ai/gateway/remote) · [Nodes](https://docs.aren.ai/nodes) · [Security](https://docs.aren.ai/gateway/security)
...
Details: [Nodes](https://docs.aren.ai/nodes) · [macOS app](https://docs.aren.ai/platforms/macos) · [Gateway protocol](https://docs.aren.ai/concepts/architecture)
...
Details: [Session tools](https://docs.aren.ai/concepts/session-tool)
...
Runbook: [iOS connect](https://docs.aren.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.aren.ai/platforms/android).
...
[Full configuration reference (all keys + examples).](https://docs.aren.ai/gateway/configuration)
...
Details: [Security guide](https://docs.aren.ai/gateway/security) · [Docker + sandboxing](https://docs.aren.ai/install/docker) · [Sandbox config](https://docs.aren.ai/gateway/configuration)

### [WhatsApp](https://docs.aren.ai/channels/whatsapp)

- Link the device: `pnpm aren channels login` (stores creds in `~/.aren/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.aren.ai/channels/telegram)
...
### [Slack](https://docs.aren.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.aren.ai/channels/discord)
...
### [Signal](https://docs.aren.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.aren.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.aren.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.aren.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.aren.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.aren.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.aren.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.aren.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.aren.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.aren.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.aren.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.aren.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.aren.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.aren.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.aren.ai/platforms/windows), [Linux](https://docs.aren.ai/platforms/linux), [macOS](https://docs.aren.ai/platforms/macos), [iOS](https://docs.aren.ai/platforms/ios), [Android](https://docs.aren.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.aren.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.aren.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.aren.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.aren.ai/gateway/bonjour)
- [Gateway pairing](https://docs.aren.ai/gateway/pairing)
- [Remote gateway README](https://docs.aren.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.aren.ai/web/control-ui)
- [Dashboard](https://docs.aren.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.aren.ai/gateway/health)
- [Gateway lock](https://docs.aren.ai/gateway/gateway-lock)
- [Background process](https://docs.aren.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.aren.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.aren.ai/logging)

## Deep dives

- [Agent loop](https://docs.aren.ai/concepts/agent-loop)
- [Presence](https://docs.aren.ai/concepts/presence)
- [TypeBox schemas](https://docs.aren.ai/concepts/typebox)
- [RPC adapters](https://docs.aren.ai/reference/rpc)
- [Queue](https://docs.aren.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.aren.ai/tools/skills-config)
- [Default AGENTS](https://docs.aren.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.aren.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.aren.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.aren.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.aren.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.aren.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.aren.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.aren.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.aren.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.aren.ai/platforms/mac/voicewake)
- [iOS node](https://docs.aren.ai/platforms/ios)
- [Android node](https://docs.aren.ai/platforms/android)
- [Windows (WSL2)](https://docs.aren.ai/platforms/windows)
- [Linux app](https://docs.aren.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.aren.ai/gmail-pubsub](https://docs.aren.ai/automation/gmail-pubsub)
