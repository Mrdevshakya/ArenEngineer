# 🦞 Aren — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/aren/aren/main/docs/assets/aren-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/aren/aren/main/docs/assets/aren-logo-text.png" alt="Aren" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/aren/aren/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/aren/aren/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/aren/aren/releases"><img src="https://img.shields.io/github/v/release/aren/aren?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/aren"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Aren** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://aren.engineer) · [Docs](https://docs.aren.engineer) · [DeepWiki](https://deepwiki.com/aren/aren) · [Getting Started](https://docs.aren.engineer/start/getting-started) · [Updating](https://docs.aren.engineer/install/updating) · [Showcase](https://docs.aren.engineer/start/showcase) · [FAQ](https://docs.aren.engineer/start/faq) · [Wizard](https://docs.aren.engineer/start/wizard) · [Nix](https://github.com/aren/nix-aren) · [Docker](https://docs.aren.engineer/install/docker) · [Discord](https://discord.gg/aren)

Preferred setup: run the onboarding wizard (`aren onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.aren.engineer/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.aren.engineer/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.aren.engineer/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.aren.engineer/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.aren.engineer/start/getting-started)

```bash
aren onboard --install-daemon

aren gateway --port 18789 --verbose

# Send a message
aren message send --to +1234567890 --message "Hello from Aren"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
aren agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.aren.engineer/install/updating) (and run `aren doctor`).
...
Switch channels (git + npm): `aren update --channel stable|beta|dev`.
Details: [Development channels](https://docs.aren.engineer/install/development-channels).
...
pnpm aren onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm aren ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `aren` binary.

## Security defaults (DM access)

Aren connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.aren.engineer/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `aren pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `aren doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.aren.engineer/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.aren.engineer/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.aren.engineer/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.aren.engineer/nodes/voicewake) + [Talk Mode](https://docs.aren.engineer/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.aren.engineer/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.aren.engineer/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.aren.engineer/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.aren.engineer/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.aren.engineer/nodes).
- **[Onboarding](https://docs.aren.engineer/start/wizard) + [skills](https://docs.aren.engineer/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=aren/aren&type=date&legend=top-left)](https://www.star-history.com/#aren/aren&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.aren.engineer/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.aren.engineer/web), and [Canvas host](https://docs.aren.engineer/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.aren.engineer/tools/agent-send): gateway, agent, send, [wizard](https://docs.aren.engineer/start/wizard), and [doctor](https://docs.aren.engineer/gateway/doctor).
- [Pi agent runtime](https://docs.aren.engineer/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.aren.engineer/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.aren.engineer/concepts/groups).
- [Media pipeline](https://docs.aren.engineer/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.aren.engineer/nodes/audio).

### Channels

- [Channels](https://docs.aren.engineer/channels): [WhatsApp](https://docs.aren.engineer/channels/whatsapp) (Baileys), [Telegram](https://docs.aren.engineer/channels/telegram) (grammY), [Slack](https://docs.aren.engineer/channels/slack) (Bolt), [Discord](https://docs.aren.engineer/channels/discord) (discord.js), [Google Chat](https://docs.aren.engineer/channels/googlechat) (Chat API), [Signal](https://docs.aren.engineer/channels/signal) (signal-cli), [iMessage](https://docs.aren.engineer/channels/imessage) (imsg), [BlueBubbles](https://docs.aren.engineer/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.aren.engineer/channels/msteams) (extension), [Matrix](https://docs.aren.engineer/channels/matrix) (extension), [Zalo](https://docs.aren.engineer/channels/zalo) (extension), [Zalo Personal](https://docs.aren.engineer/channels/zalouser) (extension), [WebChat](https://docs.aren.engineer/web/webchat).
- [Group routing](https://docs.aren.engineer/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.aren.engineer/channels).

### Apps + nodes

- [macOS app](https://docs.aren.engineer/platforms/macos): menu bar control plane, [Voice Wake](https://docs.aren.engineer/nodes/voicewake)/PTT, [Talk Mode](https://docs.aren.engineer/nodes/talk) overlay, [WebChat](https://docs.aren.engineer/web/webchat), debug tools, [remote gateway](https://docs.aren.engineer/gateway/remote) control.
- [iOS node](https://docs.aren.engineer/platforms/ios): [Canvas](https://docs.aren.engineer/platforms/mac/canvas), [Voice Wake](https://docs.aren.engineer/nodes/voicewake), [Talk Mode](https://docs.aren.engineer/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.aren.engineer/platforms/android): [Canvas](https://docs.aren.engineer/platforms/mac/canvas), [Talk Mode](https://docs.aren.engineer/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.aren.engineer/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.aren.engineer/tools/browser): dedicated aren Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.aren.engineer/platforms/mac/canvas): [A2UI](https://docs.aren.engineer/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.aren.engineer/nodes): camera snap/clip, screen record, [location.get](https://docs.aren.engineer/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.aren.engineer/automation/cron-jobs); [webhooks](https://docs.aren.engineer/automation/webhook); [Gmail Pub/Sub](https://docs.aren.engineer/automation/gmail-pubsub).
- [Skills platform](https://docs.aren.engineer/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.aren.engineer/concepts/channel-routing), [retry policy](https://docs.aren.engineer/concepts/retry), and [streaming/chunking](https://docs.aren.engineer/concepts/streaming).
- [Presence](https://docs.aren.engineer/concepts/presence), [typing indicators](https://docs.aren.engineer/concepts/typing-indicators), and [usage tracking](https://docs.aren.engineer/concepts/usage-tracking).
- [Models](https://docs.aren.engineer/concepts/models), [model failover](https://docs.aren.engineer/concepts/model-failover), and [session pruning](https://docs.aren.engineer/concepts/session-pruning).
- [Security](https://docs.aren.engineer/gateway/security) and [troubleshooting](https://docs.aren.engineer/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.aren.engineer/web) + [WebChat](https://docs.aren.engineer/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.aren.engineer/gateway/tailscale) or [SSH tunnels](https://docs.aren.engineer/gateway/remote) with token/password auth.
- [Nix mode](https://docs.aren.engineer/install/nix) for declarative config; [Docker](https://docs.aren.engineer/install/docker)-based installs.
- [Doctor](https://docs.aren.engineer/gateway/doctor) migrations, [logging](https://docs.aren.engineer/logging).
...
- **[Gateway WebSocket network](https://docs.aren.engineer/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.aren.engineer/gateway)).
- **[Tailscale exposure](https://docs.aren.engineer/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.aren.engineer/gateway/remote)).
- **[Browser control](https://docs.aren.engineer/tools/browser)** — aren‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.aren.engineer/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.aren.engineer/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.aren.engineer/nodes/voicewake) + [Talk Mode](https://docs.aren.engineer/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.aren.engineer/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Aren can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Aren enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.aren.engineer/gateway/tailscale) · [Web surfaces](https://docs.aren.engineer/web)
...
Details: [Remote access](https://docs.aren.engineer/gateway/remote) · [Nodes](https://docs.aren.engineer/nodes) · [Security](https://docs.aren.engineer/gateway/security)
...
Details: [Nodes](https://docs.aren.engineer/nodes) · [macOS app](https://docs.aren.engineer/platforms/macos) · [Gateway protocol](https://docs.aren.engineer/concepts/architecture)
...
Details: [Session tools](https://docs.aren.engineer/concepts/session-tool)
...
- Controlled via `aren nodes …`.

Runbook: [iOS connect](https://docs.aren.engineer/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.aren.engineer/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.aren/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.aren/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.aren/aren.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.aren.engineer/gateway/configuration)
...
Details: [Security guide](https://docs.aren.engineer/gateway/security) · [Docker + sandboxing](https://docs.aren.engineer/install/docker) · [Sandbox config](https://docs.aren.engineer/gateway/configuration)

### [WhatsApp](https://docs.aren.engineer/channels/whatsapp)

- Link the device: `pnpm aren channels login` (stores creds in `~/.aren/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.aren.engineer/channels/telegram)
...
### [Slack](https://docs.aren.engineer/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.aren.engineer/channels/discord)
...
### [Signal](https://docs.aren.engineer/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.aren.engineer/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.aren.engineer/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.aren.engineer/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.aren.engineer)
- [Read the architecture overview for the gateway + protocol model.](https://docs.aren.engineer/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.aren.engineer/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.aren.engineer/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.aren.engineer/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.aren.engineer/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.aren.engineer/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.aren.engineer/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.aren.engineer/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.aren.engineer/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.aren.engineer/platforms/windows), [Linux](https://docs.aren.engineer/platforms/linux), [macOS](https://docs.aren.engineer/platforms/macos), [iOS](https://docs.aren.engineer/platforms/ios), [Android](https://docs.aren.engineer/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.aren.engineer/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.aren.engineer/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.aren.engineer/gateway/discovery)
- [Bonjour/mDNS](https://docs.aren.engineer/gateway/bonjour)
- [Gateway pairing](https://docs.aren.engineer/gateway/pairing)
- [Remote gateway README](https://docs.aren.engineer/gateway/remote-gateway-readme)
- [Control UI](https://docs.aren.engineer/web/control-ui)
- [Dashboard](https://docs.aren.engineer/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.aren.engineer/gateway/health)
- [Gateway lock](https://docs.aren.engineer/gateway/gateway-lock)
- [Background process](https://docs.aren.engineer/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.aren.engineer/tools/browser-linux-troubleshooting)
- [Logging](https://docs.aren.engineer/logging)

## Deep dives

- [Agent loop](https://docs.aren.engineer/concepts/agent-loop)
- [Presence](https://docs.aren.engineer/concepts/presence)
- [TypeBox schemas](https://docs.aren.engineer/concepts/typebox)
- [RPC adapters](https://docs.aren.engineer/reference/rpc)
- [Queue](https://docs.aren.engineer/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.aren.engineer/tools/skills-config)
- [Default AGENTS](https://docs.aren.engineer/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.aren.engineer/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.aren.engineer/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.aren.engineer/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.aren.engineer/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.aren.engineer/reference/templates/TOOLS)
- [Templates: USER](https://docs.aren.engineer/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.aren.engineer/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.aren.engineer/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.aren.engineer/platforms/mac/voicewake)
- [iOS node](https://docs.aren.engineer/platforms/ios)
- [Android node](https://docs.aren.engineer/platforms/android)
- [Windows (WSL2)](https://docs.aren.engineer/platforms/windows)
- [Linux app](https://docs.aren.engineer/platforms/linux)
...
<p align="left">
  ...
  <a href="https://github.com/lutr0"><img src="https://avatars.githubusercontent.com/u/76906369?v=4&s=48" width="48" height="48" alt="lutr0" title="lutr0"/></a> <a href="https://github.com/kiranjd"><img src="https://avatars.githubusercontent.com/u/25822851?v=4&s=48" width="48" height="48" alt="kiranjd" title="kiranjd"/></a> <a href="https://github.com/danielz1z"><img src="https://avatars.githubusercontent.com/u/235270390?v=4&s=48" width="48" height="48" alt="danielz1z" title="danielz1z"/></a> <a href="https://github.com/AdeboyeDN"><img src="https://avatars.githubusercontent.com/u/65312338?v=4&s=48" width="48" height="48" alt="AdeboyeDN" title="AdeboyeDN"/></a> <a href="https://github.com/Alg0rix"><img src="https://avatars.githubusercontent.com/u/53804949?v=4&s=48" width="48" height="48" alt="Alg0rix" title="Alg0