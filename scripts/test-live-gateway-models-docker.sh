...
docker run --rm -t \
  ...
  -e AREN_LIVE_TEST=1 \
  -e AREN_LIVE_GATEWAY_MODELS="${AREN_LIVE_GATEWAY_MODELS:-${AREN_LIVE_GATEWAY_MODELS:-all}}" \
  -e AREN_LIVE_GATEWAY_PROVIDERS="${AREN_LIVE_GATEWAY_PROVIDERS:-${AREN_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e AREN_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${AREN_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${AREN_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
