...
show_usage() {
    cat << EOF
clawlog - Aren Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Aren logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Aren logs flow through the macOS unified log (subsystem: ai.aren).
