...
# Output:
# - dist/Aren.app
# - dist/Aren-<version>.zip
# - dist/Aren-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Aren-$VERSION.zip"
DMG="$ROOT_DIR/dist/Aren-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Aren-$VERSION.notary.zip"
