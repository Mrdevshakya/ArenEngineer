...
function listConfiguredAccountIds(cfg: ArenConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: ArenConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ArenConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: ArenConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: ArenConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ArenConfig): ResolvedWhatsAppAccount[] {
