...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "aren-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveArenPackageRoot } = await import("./aren-root.js");
    ...
    vi.mocked(resolveArenPackageRoot).mockResolvedValue("/opt/aren");
