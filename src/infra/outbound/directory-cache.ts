...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: ArenConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: ArenConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: ArenConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: ArenConfig): void {
