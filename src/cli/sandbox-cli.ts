...
const SANDBOX_EXAMPLES = {
  main: [
    ["aren sandbox list", "List all sandbox containers."],
    ["aren sandbox list --browser", "List only browser containers."],
    ["aren sandbox recreate --all", "Recreate all containers."],
    ["aren sandbox recreate --session main", "Recreate a specific session."],
    ["aren sandbox recreate --agent mybot", "Recreate agent containers."],
    ["aren sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["aren sandbox list", "List all sandbox containers."],
    ["aren sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["aren sandbox recreate --all", "Recreate all containers."],
    ["aren sandbox recreate --session main", "Recreate a specific session."],
    ["aren sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["aren sandbox recreate --browser --all", "Recreate only browser containers."],
    ["aren sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["aren sandbox explain", "Show effective sandbox config."],
    ["aren sandbox explain --session agent:main:main", "Explain a specific session."],
    ["aren sandbox explain --agent work", "Explain an agent sandbox."],
    ["aren sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.aren.engineer/cli/sandbox")}\n`,
    )
    .action(() => {
