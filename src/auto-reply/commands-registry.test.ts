...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@aren", { botUsername: "aren" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@aren args", {
        botUsername: "aren",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "aren" })).toBe(
      "/help@otherbot",
    );
  });
