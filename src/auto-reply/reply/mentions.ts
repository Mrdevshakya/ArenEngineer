...
function resolveMentionPatterns(cfg: ArenConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ArenConfig | undefined, agentId?: string): RegExp[] {
