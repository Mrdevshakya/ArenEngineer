...
export function listSlackAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: ArenConfig): string {
...
function mergeSlackAccountConfig(cfg: ArenConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ArenConfig): ResolvedSlackAccount[] {
