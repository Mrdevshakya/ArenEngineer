...
declare const __AREN_VERSION__: string | undefined;

const BUNDLED_VERSION =
  (typeof __AREN_VERSION__ === "string" && __AREN_VERSION__) ||
  process.env.AREN_BUNDLED_VERSION ||
  "0.0.0";
...
async function main() {
  if (hasFlag(args, "--version") || hasFlag(args, "-v")) {
    // Match `aren --version` behavior for Swift env/version checks.
