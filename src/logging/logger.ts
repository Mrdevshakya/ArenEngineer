...
export const DEFAULT_LOG_DIR = "/tmp/aren";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "aren.log"); // legacy single-file path

const LOG_PREFIX = "aren";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ArenConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ArenConfig;
      };
