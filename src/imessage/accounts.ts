...
export function listIMessageAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: ArenConfig): string {
...
function mergeIMessageAccountConfig(cfg: ArenConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: ArenConfig): ResolvedIMessageAccount[] {
