import type { ArenConfig } from "./config.js";
...
function isTelegramConfigured(cfg: ArenConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ArenConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ArenConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ArenConfig): boolean {
...
function isIMessageConfigured(cfg: ArenConfig): boolean {
...
function isWhatsAppConfigured(cfg: ArenConfig): boolean {
...
function isGenericChannelConfigured(cfg: ArenConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ArenConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ArenConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ArenConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ArenConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: ArenConfig, pluginId: string): ArenConfig {
...
function enablePluginEntry(cfg: ArenConfig, pluginId: string): ArenConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
