...
function resolveAnthropicDefaultAuthMode(cfg: ArenConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ArenConfig): ArenConfig {
...
export function applyTalkApiKey(config: ArenConfig): ArenConfig {
...
export function applyModelDefaults(cfg: ArenConfig): ArenConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ArenConfig): ArenConfig {
...
export function applyLoggingDefaults(cfg: ArenConfig): ArenConfig {
...
export function applyContextPruningDefaults(cfg: ArenConfig): ArenConfig {
...
export function applyCompactionDefaults(cfg: ArenConfig): ArenConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
