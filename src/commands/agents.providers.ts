...
function resolveDefaultAccountId(cfg: ArenConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ArenConfig): boolean {
...
export function summarizeBindings(cfg: ArenConfig, bindings: AgentBinding[]): string[] {
