...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.aren.engineer/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("aren hooks list")}`,
      `  ${formatCliCommand("aren hooks enable <name>")}`,
      `  ${formatCliCommand("aren hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
