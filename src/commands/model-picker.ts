...
function resolveConfiguredModelRaw(cfg: ArenConfig): string {
...
function resolveConfiguredModelKeys(cfg: ArenConfig): string[] {
...
export function applyPrimaryModel(cfg: ArenConfig, model: string): ArenConfig {
...
export function applyModelAllowlist(cfg: ArenConfig, models: string[]): ArenConfig {
  const defaults = cfg.agents?.defaults;
