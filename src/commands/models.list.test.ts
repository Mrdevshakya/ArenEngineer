...
const ensureArenModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveArenAgentDir = vi.fn().mockReturnValue("/tmp/aren-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/aren-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureArenModelsJson,
}));
