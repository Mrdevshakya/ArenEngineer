...
export function applyZaiConfig(cfg: ArenConfig): ArenConfig {
...
export function applyOpenrouterProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: ArenConfig): ArenConfig {
...
export function applyOpenrouterConfig(cfg: ArenConfig): ArenConfig {
...
export function applyMoonshotProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: ArenConfig): ArenConfig {
...
export function applyKimiCodeProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ArenConfig): ArenConfig {
...
export function applySyntheticProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ArenConfig): ArenConfig {
...
export function applyXiaomiProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: ArenConfig): ArenConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ArenConfig): ArenConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ArenConfig): ArenConfig {
