...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "aren-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ArenConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ArenConfig["telegram"]>>,
