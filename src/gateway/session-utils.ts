...
import { type ArenConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ArenConfig): string[] {
...
export function listAgentsForGateway(cfg: ArenConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ArenConfig): string {
...
function resolveSessionStoreAgentId(cfg: ArenConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: ArenConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: ArenConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: ArenConfig): GatewaySessionsDefaults {
