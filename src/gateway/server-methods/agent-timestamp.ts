 ...
 *
 * @see https://github.com/aren/aren/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an ArenConfig.
 */
export function timestampOptsFromConfig(cfg: ArenConfig): TimestampInjectionOptions {
  return {
