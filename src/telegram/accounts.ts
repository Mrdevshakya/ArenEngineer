...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AREN_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ArenConfig): string {
...
function mergeTelegramAccountConfig(cfg: ArenConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ArenConfig): ResolvedTelegramAccount[] {
