...
function resolveAvatarSource(cfg: ArenConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ArenConfig, agentId: string): AgentAvatarResolution {
