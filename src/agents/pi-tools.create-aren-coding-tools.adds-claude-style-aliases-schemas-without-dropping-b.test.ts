...
describe("createArenCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createArenCodingTools({
      config,
    ...
    const anthropicTools = createArenCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createArenCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createArenCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
