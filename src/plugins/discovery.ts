...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @aren/voice-call -> voice-call).
...
export function discoverArenPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".aren", "extensions")];
