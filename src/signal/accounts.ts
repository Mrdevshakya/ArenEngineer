...
export function listSignalAccountIds(cfg: ArenConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ArenConfig): string {
...
function mergeSignalAccountConfig(cfg: ArenConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ArenConfig): ResolvedSignalAccount[] {
