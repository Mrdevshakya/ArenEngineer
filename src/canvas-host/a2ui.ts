...
export const A2UI_PATH = "/__aren__/a2ui";

export const CANVAS_HOST_PATH = "/__aren__/canvas";

export const CANVAS_WS_PATH = "/__aren__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.arenCanvasA2UIAction.postMessage(...)
  // - Android: window.arenCanvasA2UIAction.postMessage(...)
  const handlerNames = ["arenCanvasA2UIAction"];
  ...
  globalThis.Aren = globalThis.Aren ?? {};
  globalThis.Aren.postMessage = postToNode;
  globalThis.Aren.sendUserAction = sendUserAction;
  globalThis.arenPostMessage = postToNode;
  globalThis.arenSendUserAction = sendUserAction;
