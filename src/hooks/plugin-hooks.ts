...
import type { ArenPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ArenPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ArenPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
